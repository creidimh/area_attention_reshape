...
/*!
 * \file area_flash_attention_tiling_key.h
 * \brief AreaFlashAttention Tiling Key 定义
 */

#ifndef __AREA_FLASH_ATTENTION_TILING_KEY_H__
#define __AREA_FLASH_ATTENTION_TILING_KEY_H__
...
ASCENDC_TPL_ARGS_DECL(AreaFlashAttention,
